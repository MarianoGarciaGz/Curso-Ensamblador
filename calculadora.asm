conf:
    ldi r16, 0x7F
    out DDRD, r16 ; Configura los primeros 7 pines del puerto C como entrada
    ldi r16, 0xFF
...
main:
    ...
    ldi r20, 16 ; Valor constante para realizar suma
    ldi r21, 32 ; Valor constante para realizar multiplicación
    ldi r21, 64 ; Valor constante para realizar multiplicación
